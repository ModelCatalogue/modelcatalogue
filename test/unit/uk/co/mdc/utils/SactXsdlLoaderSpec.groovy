...
import uk.co.mdc.Importers.SACT.XsdAny
import uk.co.mdc.Importers.SACT.XsdAttribute
import uk.co.mdc.Importers.SACT.XsdChoice
import uk.co.mdc.Importers.SACT.XsdComplexContent
import uk.co.mdc.Importers.SACT.XsdComplexType
import uk.co.mdc.Importers.SACT.XsdElement
import uk.co.mdc.Importers.SACT.XsdExtension
import uk.co.mdc.Importers.SACT.XsdGroup
import uk.co.mdc.Importers.SACT.XsdList
...
class SactXsdlLoaderSpec extends Specification {
    ...
    void "Test that an Xsd file is loaded properly"() {
        ...
        (sactDataElements, sactSimpleDataTypes, sactComplexDataTypes, sactGroups, sactAllDataElements, logErrors) = loader.parse()

        then: "File content is loaded"

        assert sactDataElements.size() == 1
