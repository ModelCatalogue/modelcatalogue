        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="pull-right">
                    <small id="pathwayDescription" editable-textarea="pathway.description"
                           e-form="pathwayDescriptionForm">
                        {{pathway.description || 'This pathway needs a description'}}
                        <small><i class="fa fa-edit" ng-click="pathwayDescriptionForm.$show()"
                                  ng-hide="pathwayDescriptionForm.$visible"></i></small>
                    </small>
                </div>
        ...
        <div id="container" class="row">
            ...
            <div class="ui-layout-center panel panel-primary">
                <div mc-graph-container
                    ...
                    <div mc-graph-node graph-node="node" select-node="selectNode(node)" dbl-click="viewSubpathway(node)"
                         ng-keyup="deleteKeyPressed($event, node)" tabindex="{{100 + $index}}"
                         is-selected="isSelected(node)" ng-repeat="node in pathway.nodes"></div>
            ...
            <div class="ui-layout-east panel panel-primary" >
                <div class="panel-heading">
                    Properties
                </div>

                <div ng-controller="NodePropertiesCtrl">
                    <div ng-controller="LinkPropertiesCtrl">
                        <div class="panel-body" ng-hide="selectedNode || selectedLink">
                            <p>Select a node or link to view it's properties</p>
                        </div>
                    </div>
                </div>
                <div ng-controller="LinkPropertiesCtrl" >
                    <div ng-show="selectedLink" id="LinkPropertiesPanel">
                        <h4><a href="#" editable-text="selectedLink.name">{{ selectedLink.name || "empty" }}</a></h4>
                        <p><a href="#" editable-text="selectedLink.description">{{ selectedLink.description || "empty" }}</a></p>
                        <button type="button" class="btn btn-danger btn-xs" ng-click="deleteLink()">
                ...
                <div ng-controller="NodePropertiesCtrl">
                    ...
                    <div class="panel-body" ng-show="selectedNode" id="NodePropertiesPanel">
                        <h4><a href="#" editable-text="selectedNode.name">{{ selectedNode.name || "empty" }}</a><button type="button" class="btn btn-danger btn-xs pull-right"
                                                                                                                        ng-click="deleteNode()">
                            <i class="fa fa-trash-o"></i> Delete
                        </button></h4>
...
<!-- Add CollectionModal -->
    <div class="modal fade" id="AddCollectionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div id="collectionCart">Drag Collection Here To Add <i style="display:block"
                                                                            class="fa fa-plus"></i>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary"
                            data-bind="click: $root.refreshCollections">Refresh</button>
                    <button type="button" class="btn btn-primary"
                            data-bind="click: $root.addNewDECollection">Add New DE Collection</button>
                    <button type="button" class="btn btn-primary"
                            data-bind="click: $root.addCollectionFinish">Finish</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
...
<!-- Add NewDECollectionModal -->
    <div class="modal fade" id="AddNewDECollectionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div id="deCollectionCart">Drag Data Element Here To Add <i style="display:block"
                                                                                class="fa fa-plus"></i>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary"
                            data-bind="click: $root.addNewDECollectionFinish">Finish</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
